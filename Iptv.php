...
<div class="zbz-slide-keeper">
	...
	<div class="zbz-bg-cover" style="background-image: linear-gradient(45deg, #7e357b82, #7e357b30),url(images/bg3.jpg);"></div>
	...
	<section class="zbz-slide" data-nav="Home">
		...
		<?php
		$get_sixth_sec = "SELECT * FROM hero_iptv";
								...
								<div class="col-sm-8 col-lg-6">
									<div class="zbz-feature-side zbz-xs-3x zbz-sm-4x">
										...
										<div class="zbz-description">
											<div>
												<img class="img-fluid" src="images/hdtv_filled.svg" alt="" style="width: 60px;">
											</div>
	...
	<?php
	$get_sixth_sec = "SELECT * FROM iptv_first";
	$result_sixth_sec = $conn->query($get_sixth_sec);
							...
							<div class="row align-item-center" data-appear="slideInUp" data-disappear="slideOutUp">
								...
								<div class="col-md-6">
									<div class="main_content">
										<!-- <h3 class=""><strong>SIR Media offers an impressive collection of on-demand
											movies, live action, and TV Shows</strong></h3> -->
